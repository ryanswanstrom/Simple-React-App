...
function App() {
  return (
    ...
    <div className="pt-[10vh] px-2 mx-auto max-w-[880px] lg:min-h-screen">
        ...
        <h2 className="text-white text-center font-bold mb-4 text-[24px]">Ryan Swanstrom</h2>
        ...
        <p> via <a href="https://ryanswanstrom.com" className="text-[#A99FFB] hover:text-white transition-all delay-100">Ryan Swanstrom</a> Thanks for viewing </p>
        </div>
    </div>
    </div>
  );
